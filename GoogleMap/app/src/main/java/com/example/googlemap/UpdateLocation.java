...
public class UpdateLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_moTa_save.setText(getIntent().getStringExtra("moTa"));
        text_ten_save.setText(getIntent().getStringExtra("tenViTri"));
        bt_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(UpdateLocation.this, List_addr.class);
        ...
        bt_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(tenViTri) && !TextUtils.isEmpty(moTa)) {
                    ...
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("viTri").child(id);
                    ViTri viTri = new ViTri(id, tenViTri, moTa, lat, lon);
                    databaseReference.setValue(viTri);
